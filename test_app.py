...
Altered_Token = {'Authorization': 'Bearer ' + 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6ImtlZGJsRHk2OHhSbWQuWXhZaWhvcyJ9..IO6LpRmJ2g23KUReoNKI6WvAEUPYITQJXBofEFMNVJmBBjNiJiQLw6cFqM5Tr2RH7VpUgFbPn_F7A2FkNsEKCQ0-Bfwe0Y_mekLFZ145R9uM7adfFfGB-70zV3Gj84d4Fsq53pDZ2dld1XIPS48qjn_LWxBkbPqY6EMJCuC7mCyOm3nyeUOHGyV_vozq7FPkx5L8D27bEXxzX08H4y3q6tcFPtDxmv81suJ9lEDsVslyKLfk9r1Rgm8F_txT7QziuY_aCZOSOompCrQh5W4BgfCCPJg_RsVD3ltUn62vpf2aTSamyVCA_sjNbnkbo2OCp8KaHvmbM362DjPw7JJ3tw'}
...
class CoffeeShopTestCase(unittest.TestCase):
    ...
    # test get drinks detail error in authentication

    def test_get_drinks_detail_error(self):
        res = self.client().get('/drinks-detail', headers=Altered_Token)
        data = json.loads(res.data)
