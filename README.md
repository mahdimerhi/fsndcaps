...
{"drinks": [{"id": 1, "recipe": [{"color": "blue", "parts": 1}],
    "title": "water"}], "success": true}
...
Sample response output:
{"drinks": [{"id": 1, "recipe": [{"color": "blue", "name": "water",
    "parts": 1}], "title": "water"}], "success": true}
...
Sample response output:
{"drinks": [{"id": 2, "recipe": [{"color": "blue", "name": "Water",
    "parts": 1}], "title": "Water1"}], "success": true}
...
Sample response output:
{"drinks": [{"id": 1, "recipe": [{"color": "blue", "name": "Water",
    "parts": 2}], "title": "Water_Long"}], "success": true}
